...
class Mão:
    ...
    # Alias usado em feitiços.py
    @property
    def qtd_cartas_na_mão(self) -> int:
        return self.qtd
    ...
    # Alias usado em feitiços.py
    def get_carta(self, pos: int) -> Optional[Carta]:
        return self.pegar(pos)
...
class Baralho:
    ...
    # Alias usado em feitiços.py
    @property
    def qtd_cartas_no_baralho(self) -> int:
        return self.qtd
